def englishNumber number
  ...
  left  -= write*1000000000  # Subtract off those billion.
...
def beer_song
  ...
  loop do
    puts "Let's sing a song about beer. How much beer should we sing about?[1 - 9999]"
    number_of_bottles = gets.chomp
    break if (Integer(number_of_bottles) rescue false) && number_of_bottles.to_i.between?(1,9999) 
    puts "Must enter a number between 1 and 9999."
  end
  ...
  while number_of_bottles > 0
    if number_of_bottles == 1
      puts "#{englishNumber(number_of_bottles)} bottle of beer on the wall."
      puts "#{englishNumber(number_of_bottles)} bottle of beer, take one down, pass it around."
      puts "No more bottles of beer on the wall!"
      number_of_bottles -= 1
    else
      puts "#{englishNumber(number_of_bottles)} bottles of beer on the wall."
      puts "#{englishNumber(number_of_bottles)} bottles of beer, take one down, pass it around."
      number_of_bottles -= 1
      if number_of_bottles == 1
        puts "#{englishNumber(number_of_bottles)} bottle of beer on the wall!"
      else
